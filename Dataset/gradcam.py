...
def main():
    # Path setup
    image_path = "Dataset\MURA-v1.1\\valid\XR_WRIST\patient11385\study1_negative\image3.png"
    classifier_weights_path = "trained_model/18simclr_classifier_model.pth"
